...
abstract class NoteDTO implements _$NoteDTO {
  ...
  const factory NoteDTO({
    ...
    // FieldValues are placeholder values for Firestore purposes only
    // Must use ServerTimestampConverter as a custom converter
...
/// Customer converter for json_serializable to properly serialize the server timestamp from Firestore
