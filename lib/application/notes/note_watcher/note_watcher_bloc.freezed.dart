...
// ignore: unused_element
  _NotesReceived notesReceived(Either<NoteFailure, KtList<Note>> failureNotes) {
...
mixin _$NoteWatcherEvent {
  ...
  TResult when<TResult extends Object>({
    ...
    @required
        TResult notesReceived(Either<NoteFailure, KtList<Note>> failureNotes),
  });
  @optionalTypeArgs
  ...
  $Res call({
    ...
    return _then(_NotesReceived(
      failureNotes == freezed
          ? _value.failureNotes
          : failureNotes as Either<NoteFailure, KtList<Note>>,
    ));
  }
}
...
class _$_NotesReceived implements _NotesReceived {
  const _$_NotesReceived(this.failureNotes) : assert(failureNotes != null);
  ...
  @override
  String toString() {
    return 'NoteWatcherEvent.notesReceived(failureNotes: $failureNotes)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _NotesReceived &&
            (identical(other.failureNotes, failureNotes) ||
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(failureNotes);
  ...
  TResult when<TResult extends Object>({
    ...
    assert(watchUncompletedStarted != null);
    assert(notesReceived != null);
    return notesReceived(failureNotes);
  }
...
abstract class _NotesReceived implements NoteWatcherEvent {
  const factory _NotesReceived(Either<NoteFailure, KtList<Note>> failureNotes) =
      _$_NotesReceived;
